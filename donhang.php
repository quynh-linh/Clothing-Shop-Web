                            ...
                            <table class="display display_1">
                                ...
                                <?php
                                    ...
                                    if ($getOrderHistory1) {
                                        ...
                                        ?>
                                        <td colspan="7" style="background-color:#2a2b2c;text-align:center;color:white;">Tổng đơn hàng: <?php echo number_format($total1, 0, ',', '.') . "" . "đ";?></td>
                                        <td colspan="2" class="confirm" style="background-color:#2a2b2c;"> <a style="text-decoration:none;font-size:20px;" onclick="return confirm('Bạn muốn xác nhận lấy hàng')" href="?orderID=<?php echo $orderID ?>&status=1" class="ti-check"></a>
                                        </td>
                                        <?php
                                    }
                                }
                            ...
                            <table class="display display_2">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <td colspan="2" class="confirm" style="background-color:#2a2b2c"><a style="text-decoration:none;font-size:20px;" onclick="return confirm('Bạn muốn trả hàng?')" href="?orderID=<?php echo $orderID ?>&status=2" class="ti-close"></a></td>
                                    <?php
                                    }
                                }
                            //}
                                    ...
                                    if ($getOrderHistory2) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="color:red;cursor:pointer">Chờ admin xác nhận</td>
